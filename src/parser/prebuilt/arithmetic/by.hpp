#ifndef PARSER_PREBUILT_ARITHMETIC_BY_HPP
#define PARSER_PREBUILT_ARITHMETIC_BY_HPP
...
{
    class by : public ratl::parse_node<int, void>
    {
        private:
        ...
        public:
            inline explicit by(const std::string&): node(identifier, type, operands_order)
            {
            }
...
#endif// PARSER_PREBUILT_ARITHMETIC_BY_HPP
